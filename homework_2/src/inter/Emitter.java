...
public final class Emitter {
	...
	/*
	 * Uso o tipo do operando e não do destino, pois no comando %3 = fcmp olt double
	 * 0.0, %2 o destino é booleano, mas os operandos double
	 */
	// %6 = add i32 %4, %5
	...
	// %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds([7 x i8], [7 x
	// i8]* @str_print_double, i32 0, i32 0), double %23) ; var %23
	...
	public void emitRead(Expr id) {
		String str = "[3 x i8], [3 x i8]* @str_read_int";
		if (id.type().isReal())
	...
	public void emitHead(Token name) {
		...
		emit("@str_read_int = private unnamed_addr constant [3 x i8] c\"%d\\00\", align 1");
		emit("@str_read_double = private unnamed_addr constant [4 x i8] c\"%lf\\00\", align 1");
